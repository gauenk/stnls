...
setup(name='stnls',
      ...
      ext_modules=[
          CUDAExtension('stnls_cuda', [
              ...
              # 'lib/csrc/search/non_local_search_bilin3d_kernel.cu',
              ...
              'lib/csrc/reducer/iwpsum_int_kernel.cu',
              'lib/csrc/reducer/iwpsum_bilin2d_kernel.cu',
              'lib/csrc/reducer/iwpsum_bwd_kernels.cu',
