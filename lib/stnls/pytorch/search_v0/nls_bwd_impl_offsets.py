...
def nls_backward_offsets(ctx, grad_dists, grad_inds):
    ...
    # -- populate names --
    inds,vid0,vid1,fflow,bflow,offsets = ctx.saved_tensors
    ...
    grad_offsets = th.zeros_like(offsets)
