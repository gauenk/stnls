...
setup(name='dnls',
      ...
      ext_modules=[
          CUDAExtension('dnls_cuda', [
              'csrc/tile_k/gather_cuda.cpp',
              'csrc/tile_k/gather_kernel.cu',
              'csrc/tile_k/scatter_cuda.cpp',
              'csrc/tile_k/scatter_kernel.cu',
              ...
              'csrc/reduce/wpsum_cuda.cpp',
              'csrc/reduce/wpsum_kernel.cu',
              'csrc/pybind.cpp',
          ])
      ],
