...
__global__ void non_local_stack_int_forward_kernel(
...
void non_local_stack_int_forward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "non_local_stack_int_forward_kernel", ([&] {
        non_local_stack_int_forward_kernel<scalar_t><<<blocksPerGrid, threadsPerBlock>>>(
...
__global__ void non_local_stack_int_backward_kernel(
  ...
  #pragma unroll
      ...
      fill_non_local_patch_bwd_int<scalar_t>(grad_vid[ibatch][ihead],
...
void non_local_stack_int_backward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "non_local_stack_int_backward_kernel", ([&] {
        non_local_stack_int_backward_kernel<scalar_t><<<blocksPerGrid, threadsPerBlock>>>(
