...
__global__ void gather_bilin2d_forward_kernel(
  ...
  #pragma unroll
      ...
      gather_patch_fwd_bilin2d<scalar_t>(stack[ibatch][ihead][ki],
                                             counts[ibatch][ihead],
                                             vid[ibatch][ihead_v],
...
void gather_bilin2d_forward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "gather_bilin2d_forward_kernel", ([&] {
        gather_bilin2d_forward_kernel<scalar_t>
...
template <typename scalar_t>
__global__ void gather_bilin2d_backward_kernel(
...
void gather_bilin2d_backward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "gather_bilin2d_backward_kernel", ([&] {
        gather_bilin2d_backward_kernel<scalar_t>
          <<<blocksPerGrid, threadsPerBlock>>>(
