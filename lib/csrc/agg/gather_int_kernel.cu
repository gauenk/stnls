...
__global__ void gather_int_forward_kernel(
  ...
  #pragma unroll
      ...
      gather_patch_fwd_int<scalar_t>(stack[ibatch][ihead][ki],
                                     counts[ibatch][ihead],
                                     vid[ibatch][ihead],
...
void gather_int_forward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "gather_int_forward_kernel", ([&] {
        gather_int_forward_kernel<scalar_t><<<blocksPerGrid, threadsPerBlock>>>(
...
template <typename scalar_t>
__global__ void gather_int_backward_kernel(
  ...
  #pragma unroll
      ...
      gather_patch_bwd_int<scalar_t>(grad_vid[ibatch][ihead],
...
void gather_int_backward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "gather_int_backward_kernel", ([&] {
        gather_int_backward_kernel<scalar_t><<<blocksPerGrid, threadsPerBlock>>>(
