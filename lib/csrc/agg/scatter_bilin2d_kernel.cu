...
__global__ void scatter_bilin2d_forward_kernel(
...
void scatter_bilin2d_forward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "scatter_bilin2d_forward_kernel", ([&] {
        scatter_bilin2d_forward_kernel<scalar_t>
...
template <typename scalar_t>
__global__ void scatter_bilin2d_backward_kernel(
...
void scatter_bilin2d_backward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(vid.type(), "scatter_bilin2d_backward_kernel", ([&] {
        scatter_bilin2d_backward_kernel<scalar_t>
          <<<blocksPerGrid, threadsPerBlock>>>(
