...
__global__ void scatter_add_int_forward_kernel(
...
void scatter_add_int_forward_cuda(
  ...
  // -- launch kernel --
  AT_DISPATCH_FLOATING_TYPES(in_vid.type(), "scatter_add_int_forward_kernel", ([&] {
    scatter_add_int_forward_kernel<scalar_t><<<nblocks, nthreads>>>(
