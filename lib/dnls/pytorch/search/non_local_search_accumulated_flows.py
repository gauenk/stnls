...
class NonLocalAccFlowsSearchFunction(th.autograd.Function):
...
class NonLocalAccFlowsSearch(th.nn.Module):
    ...
    def forward(self, vid0, vid1, fflow, bflow, qshift=0, nqueries=-1):
        return NonLocalAccFlowsSearchFunction.apply(vid0,vid1,fflow,bflow,
...
_apply = NonLocalAccFlowsSearchFunction.apply # api
